...
SlotRect {
    ...
    scale: isDown ? 0.96 : 1
    color: solid ? (isHovered ? Qt.darker(base, 1.08) : base) : variant === "ghost" ? (isHovered ? Qt.alpha(t.text, 0.06) : "transparent") : (isHovered ? Qt.darker(t.surfaceAlt, 1.04) : t.surfaceAlt)
